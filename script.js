document.addEventListener("DOMContentLoaded", function () {
    const SUPABASE_URL = "https://rumwblrhxwthzqwphbso.supabase.co";
    const SUPABASE_ANON_KEY = "sb_publishable_9pud97sxTfmcMHSRXKNo3w_4dzo5O-g";
    ...
    function getStorageKey() {
        if (currentMode === "guest") {
            return "unibudgetData_guest";
        }

        if (currentUser) {
            return "unibudgetData_" + currentUser.id;
        }
    ...
    function showApp() {
        ...
        if (currentMode === "guest") {
            ...
            sessionStatus.textContent = "Logged in: " + currentUser.email;
        }
    ...
    signupBtn.addEventListener("click", async function () {
        ...
        authMessage.textContent = "Sign up successful. Now log in.";
    });
